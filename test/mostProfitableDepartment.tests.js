...
describe('test my function mostProfitableDepartment', function(){
    ...
    it('it should return the most profitable department', function(){
        var salesData3 = [
            ...
            {department : 'steelwork', sales : 1500, day : 'Wednesday'},
            {department : 'carpentry', sales : 8009, day : 'Wednesday'},
            {department : 'steelwork', sales : 55500, day : 'Wednesday'},
        ];
        assert.equal('steelwork', mostProfitableDepartment(salesData3), "Most profitable department is 'steelwork' for dataset 3");
    });
});